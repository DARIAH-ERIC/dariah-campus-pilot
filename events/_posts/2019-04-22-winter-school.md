...
<!--                                    <svg class="svg-icon" aria-hidden="true">-->
<!--                                        <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-facebook" />-->
<!--                                        <use xlink:href="#svg_icon-facebook" />-->
<!--                                    </svg>-->
<!--                                    <span class="sr-only">Share on Twitter</span>-->
<!--                                </a>-->
<!--                            </li>-->
...
<!--                                    <svg class="svg-icon" aria-hidden="true">-->
<!--                                        <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-googleplus" />-->
<!--                                        <use xlink:href="#svg_icon-googleplus" />-->
<!--                                    </svg>-->
<!--                                    <span class="sr-only">Share on Twitter</span>-->
<!--                                </a>-->
<!--                            </li>-->
...
<div class="body__borders">
    ...
    <div class="pos-r sticky-position-container">
        ...
        <div class="session" id="session-5">
            ...
            <div class="session__core">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/5.3-Galleron.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__speakers">
                    ...
                    <ul class="list-speakers">
                        ...
                        <li>
                            ...
                            <img src="../static/img/generic/pp_ioana-galleron.jpg" alt="">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/DARIAH_Winter_School-5-EvaluationAcknowledgementandCreditCirculation.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
        ...
        <div class="session" id="session-6">
            ...
            <div class="session__heading">
                ...
                <a href="../content/DARIAH_Winter_School-6-CaseStudies.pdf" class="link-download" title="Download the session synthesis">
                    <svg class="svg-icon" aria-hidden="true">
                        <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                        <use xlink:href="#svg_icon-pdf-wide" />
                    </svg>
            ...
            <div class="session__core">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/6.1-Mounier.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__speakers">
                    ...
                    <ul class="list-speakers">
                        ...
                        <li>
                            ...
                            <img src="../static/img/generic/pp_pierre-mounier.jpg" alt="">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/6.2-Malinek.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__speakers">
                    ...
                    <ul class="list-speakers">
                        ...
                        <li>
                            ...
                            <img src="../static/img/generic/pp_vojtech-malinek.jpg" alt="">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/6.3-Maciej.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__speakers">
                    ...
                    <ul class="list-speakers">
                        ...
                        <li>
                            ...
                            <img src="../static/img/generic/pp_maciej-maryl.jpg" alt="">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/6.4-Kovalenko.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/6.5-Free.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/6.6-Messina.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/6.7-Papaki.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__speakers">
                    ...
                    <ul class="list-speakers">
                        ...
                        <li>
                            ...
                            <img src="../static/img/generic/pp_eliza-papaki.jpg" alt="">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/DARIAH_Winter_School-6-CaseStudies.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
        ...
        <div class="session" id="session-7">
            ...
            <div class="session__heading">
                ...
                <a href="../content/DARIAH_Winter_School-7-DataJournalsEditorializationofOpenData.pdf" class="link-download" title="Download the session synthesis">
                    <svg class="svg-icon" aria-hidden="true">
                        <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                        <use xlink:href="#svg_icon-pdf-wide" />
                    </svg>
            ...
            <div class="session__core">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/7.1-Baillot.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/DARIAH_Winter_School-7-DataJournalsEditorializationofOpenData.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
        ...
        <div class="session" id="session-8">
            ...
            <div class="session__heading">
                ...
                <a href="../content/DARIAH_Winter_School-8-EconomyofOpenAccessOpenDataPublication.pdf" class="link-download" title="Download the session synthesis">
                    <svg class="svg-icon" aria-hidden="true">
                        <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                        <use xlink:href="#svg_icon-pdf-wide" />
                    </svg>
            ...
            <div class="session__core">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/8.1-Mounier.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__speakers">
                    ...
                    <ul class="list-speakers">
                        ...
                        <li>
                            ...
                            <img src="../static/img/generic/pp_patrick-flack.jpg" alt="">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/DARIAH_Winter_School-8-EconomyofOpenAccessOpenDataPublication.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
        ...
        <div class="session" id="session-9">
            ...
            <div class="session__heading">
                ...
                <a href="../content/DARIAH_Winter_School-9-InfrastructurePlatform.pdf" class="link-download" title="Download the session synthesis">
                    <svg class="svg-icon" aria-hidden="true">
                        <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                        <use xlink:href="#svg_icon-pdf-wide" />
                    </svg>
            ...
            <div class="session__core">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/9.1-Plantin.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__speakers">
                    ...
                    <ul class="list-speakers">
                        ...
                        <li>
                            ...
                            <img src="../static/img/generic/pp_jean-christophe-plantin.jpg" alt="">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/9.2-Larrousse.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
                ...
                <div class="session__speakers">
                    ...
                    <ul class="list-speakers">
                        ...
                        <li>
                            ...
                            <img src="../static/img/generic/pp_nicolas-larousse.jpg" alt="">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/DARIAH_Winter_School-9-InfrastructurePlatform.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
        ...
        <div class="session" id="session-10">
            ...
            <div class="session__heading">
                ...
                <a href="../content/DARIAH_Winter_School-10-Socialimpact.pdf" class="link-download" title="Download the session synthesis">
                    <svg class="svg-icon" aria-hidden="true">
                        <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                        <use xlink:href="#svg_icon-pdf-wide" />
                    </svg>
            ...
            <div class="session__core">
                ...
                <div class="session__speakers">
                    ...
                    <ul class="list-speakers">
                        ...
                        <li>
                            ...
                            <img src="../static/img/generic/pp_gregory-crane.jpg" alt="">
                ...
                <div class="session__downloads">
                    ...
                    <a href="../content/DARIAH_Winter_School-10-Socialimpact.pdf" class="link-download">
                        <svg class="svg-icon" aria-hidden="true">
                            <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-pdf-wide" />
                            <use xlink:href="#svg_icon-pdf-wide" />
                        </svg>
    ...
    <div id="footer" class="clearfix">
        ...
        <div class="footer__credits">
            <p>Open Data Citation for Social Sciences and Humanities / 2016</p>
        </div><!-- /.footer__credits -->
...
<div class="popin-overlay" id="popin-about">

    <div class="popin-content">

        <button class="popin-closer button-picto button-picto--naked show-hide-close" aria-label="Fermer">
            <svg class="svg-icon" aria-hidden="true">
                <use xlink:href="../static/img/svg-sprite/svg-sprite.svg#svg_icon-close" />
                <use xlink:href="#svg_icon-close" />
            </svg>
        </button>
